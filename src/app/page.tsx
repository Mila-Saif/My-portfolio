...
const ButterflyScene = dynamic(() => import("@/components/ButterflyScene"), {
  ssr: false,
});
  ...
  return (
    <main className=" min-h-screen bg-linear-to-br from-blue-950 via-indigo-950 to-slate-950 text-white p-8 ">
      <div className="max-w-7xl mx-auto mt-1"  >
        ...
        {/* the hero section */}
        <section id="home" className="relative flex flex-col justify-center min-h-[85vh] mt-20 md:mt-10 px-4">

          {/* Ambient glowing particles across the hero */}
          <HeroParticles />
          ...
          {/* 3D Butterfly Animation - responsive: below text on mobile, right side on md+ */}
          <div className="relative md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 w-[250px] h-[250px] mx-auto mt-8 md:mt-0 md:mx-0 md:w-[280px] md:h-[280px] lg:w-[320px] lg:h-[320px] xl:w-[420px] xl:h-[420px] pointer-events-auto">
            <ButterflyScene />
          </div>
